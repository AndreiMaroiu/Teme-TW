...
CREATE TABLE `producer_stock` (
  ...
  CONSTRAINT `producer_if` FOREIGN KEY (`id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `producer_stock` VALUES (1,1,1),(2,3,5);
...
-- Dump completed on 2022-01-16 14:53:34
